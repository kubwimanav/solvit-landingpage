...
function IconCard( {icon,title,description,children} ) {
  return (
    <div className="  bg-teal-50 p-5 border border-teal-100 w-3xs sm:w-md  md:w-5xl lg:w-3xs">
      ...
      <h3 className="text-xl font-bold text-gray-800 mb-3  text-center sm:text-xs md:h-3">
        {title}
      </h3>
